            ...
            <Wrapper>
                <div className="artist-container">
                    ...
                    <div className="artist-info">
                        ...
                        ) : (<h3><span>{artist.locale}</span></h3>)}
                        <p className="description">{artist.description}</p>
                        <p className="info"><strong>Email: </strong>{artist.email}</p>
                        <p className="info"><strong>Phone: </strong>{artist.phone}</p>
                        <p className="info"><strong>Height: </strong>{artist.height}</p>
                        <p className="info"><strong>Shoe Size: </strong>{artist.shoeSize}</p>    
                    </div>
                </div>
